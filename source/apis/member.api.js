...
export class MemberApi{
    ...
    liulan(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/liulan',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    typeslist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/typeslist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
